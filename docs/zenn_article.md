...
- 🌐 ライブデモ: https://price-sheet-agent.vercel.app （※ハッカソン終了に伴い 2026-06-11 公開終了。動作はデモ動画をご覧ください）
...
> ⚠️ ライブデモ（https://price-sheet-agent.vercel.app）と Azure バックエンドは、ハッカソン終了に伴い **2026-06-11 をもって公開終了**しました（課金停止のため）。下記の動作はデモ動画でご確認いただけます。ローカルでの再現手順は GitHub リポジトリを参照してください。

🎥 デモ動画: https://youtu.be/VzxOywOETuw

（公開当時）トップの「⭐推奨デモ（自己検証ループ）」ボタンを押すと、劣化サンプルPDFが読み込まれ、「抽出する」で実行できました。
...
| 成果物URL | https://price-sheet-agent.vercel.app （※2026-06-11 公開終了） |
| GitHub | https://github.com/nakakei6439/PriceSheetAgent |
| デモ動画 | https://youtu.be/VzxOywOETuw |
...
### 参考リンク
- デモ動画: https://youtu.be/VzxOywOETuw
- デモ（ライブ）: https://price-sheet-agent.vercel.app （※2026-06-11 公開終了）
- GitHub: https://github.com/nakakei6439/PriceSheetAgent
